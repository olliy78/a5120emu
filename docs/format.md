...
> `tools/format_all.py` legt `.hfe`-Ziele als **unformatiertes** Medium in der Geometrie des
> Laufwerks an (`createB` = *leerer* Formatname), und `tools/cpa_tools/make_bootdisk.py`
...
**Pipeline-Tool** `tools/cpa_tools/make_bootdisk.py` (6 Presets, s. §8.6.1): legt eine
